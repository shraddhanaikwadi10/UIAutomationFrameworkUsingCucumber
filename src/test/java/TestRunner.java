...
@CucumberOptions(features = "src/test/resources/features", glue = { "stepdefs" }, tags = { "~@Ignore" }, format = {
		...
		"json:target/cucumber-reports/CucumberTestReport.json", "rerun:target/cucumber-reports/rerun.txt", }, plugin = {
				"com.sitture.ExtentFormatter:output/extent-report/index.html", "html:output/html-report" })
...
public class TestRunner {
	...
	public void tearDownClass() throws Exception {
		...
		ExtentReporter.setConfig("config.xml");
